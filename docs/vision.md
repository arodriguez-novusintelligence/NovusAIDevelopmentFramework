...
- Flujo principal: Lovable → Web (18 pasos multiagente, alineado al canónico global — [ADR-0003](../.nadf/global/decision-history/adr/ADR-0003-lovable-to-web-canonicalization.md))
