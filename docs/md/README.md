...
metodología, gobierno, assets y adapters para implantar entrega de software con
IA bajo control humano.

## Recorrido recomendado

1. [Adopción empresarial](02-adopcion-y-distribucion.md)
2. [Aprobaciones y responsabilidades](09-aprobaciones-y-responsabilidades.md)
3. [Entregables y outputs](10-entregables-y-outputs.md)
4. [Samples](11-ejemplos-sample1-sample2.md)
5. [Tiempos y rendimiento](12-tiempos-y-rendimiento.md)
6. [Cloud Agent y runtime](13-cloud-agent-y-runtime.md)
